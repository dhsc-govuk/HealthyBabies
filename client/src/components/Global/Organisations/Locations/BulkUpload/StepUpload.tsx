    ...
    <div>
      ...
      <div className="bulk-upload-content">
        ...
        <h1 className="bulk-upload-heading">
          Upload the spreadsheet with delivery location information
        </h1>
      </div>

      {/* File upload */}
      <div className="bulk-upload-file">
        <label className="bulk-upload-file__label">Sites spreadsheet</label>
        <div className="bulk-upload-file__hint">
          <p style={{ marginBottom: '10px' }}>
            Upload the completed template with site information for all delivery locations.
          </p>
          <p style={{ marginBottom: '10px' }}>Before you upload, make sure you have:</p>
          <ul>
            <li>added all sites to your delivery location list</li>
            <li>confirmed the information in your delivery location list is up to date</li>
