...
import { User, UserReducerAction, validationErrors, ValidationErrors } from '..';
...
const StepDetails = ({ user, errors, setErrors, dispatch, emailReadOnly = false }: Props): React.ReactElement => {
