...
const UserSteps = ({ completeLabel, user, dispatch, handleSave, emailReadOnly = false, onCancel }: Props): React.ReactElement => {
  ...
  const stepperSteps = [
    {
      label: 'Details',
      component: <StepDetails user={user} errors={errors} setErrors={setErrors} dispatch={dispatch} emailReadOnly={emailReadOnly} />,
    },
    {
