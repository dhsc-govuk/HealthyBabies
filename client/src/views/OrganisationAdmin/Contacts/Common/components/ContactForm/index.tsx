...
const ContactForm = ({ contact, errors, setErrors, dispatch, roles }: Props): React.ReactElement => {
    ...
    <>
      ...
      <GovUKFieldset legend="Contact details" legendSize="m">
        ...
        <GovUKFieldset.Select
          ...
          required
          onChange={(e: React.ChangeEvent<HTMLSelectElement>) => dispatch({ type: ContactReducerAction.ROLE, value: e.target.value })}
        />
      </GovUKFieldset>
    </>
  );
