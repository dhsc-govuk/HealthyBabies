    ...
    <>
      ...
      <GovUKFieldset legend="Question Details" legendSize="m">
        <GovUKFieldset.Input
          ...
          required
          disabled={isEdit}
          onChange={(e) => dispatch({ type: ActionType.SET_CODE, payload: e.target.value.toUpperCase() })}
        ...
        <GovUKFieldset.Input
          ...
          required
          onChange={(e) => dispatch({ type: ActionType.SET_LABEL, payload: e.target.value })}
        ...
        <GovUKFieldset.Input
          ...
          onChange={(e) => dispatch({ type: ActionType.SET_HINT, payload: e.target.value })}
        />
        <GovUKFieldset.Input
          ...
          onChange={(e) => dispatch({ type: ActionType.SET_PLACEHOLDER, payload: e.target.value })}
        />
        <GovUKFieldset.Select
          ...
          required
          onChange={(e) => dispatch({ type: ActionType.SET_QUESTION_TYPE, payload: Number(e.target.value) })}
        />
        <GovUKFieldset.Input
          id="question-help-text-summary"
          name="helpTextSummary"
          label="Help Text Summary"
          hint="The clickable link text for expandable help (e.g., 'Help with locations')"
          value={formState.helpTextSummary}
          onChange={(e) => dispatch({ type: ActionType.SET_HELP_TEXT_SUMMARY, payload: e.target.value })}
        />
        <GovUKFieldset.Input
          ...
          onChange={(e) => dispatch({ type: ActionType.SET_HELP_TEXT, payload: e.target.value })}
        />
      </GovUKFieldset>
      ...
      <GovUKFieldset legend="Conditional Display" legendSize="m">
        <GovUKFieldset.Select
          ...
          onChange={(e) => dispatch({ type: ActionType.SET_CONDITIONAL_QUESTION_CODE, payload: e.target.value })}
        />
        {formState.conditionalQuestionCode && (
          <GovUKFieldset.Select
            ...
            onChange={(e) => dispatch({ type: ActionType.SET_CONDITIONAL_VALUE, payload: e.target.value })}
          />
        )}
      </GovUKFieldset>
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                onChange={(e) => dispatch({ type: ActionType.SET_IS_REQUIRED, payload: e.target.checked })}
              />
            }
            label="Required"
          />
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={(e) => dispatch({ type: ActionType.SET_IS_ACTIVE, payload: e.target.checked })}
                />
              }
              label="Active"
            />
