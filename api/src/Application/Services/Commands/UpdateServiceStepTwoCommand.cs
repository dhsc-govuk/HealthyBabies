...
public record UpdateServiceStepTwoCommand : IRequest<Either<ServiceException, Service>>
{
...
public class UpdateServiceStepTwoCommandHandler(
    PermissionsService permissionsService,
    IServiceRepository serviceRepository,
    IServiceFormQuestionQueries questionQueries)
    : IRequestHandler<UpdateServiceStepTwoCommand, Either<ServiceException, Service>>
{
    public async Task<Either<ServiceException, Service>> Handle(
        UpdateServiceStepTwoCommand request,
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var questions = await questionQueries.GetByStep(2, cancellationToken);
